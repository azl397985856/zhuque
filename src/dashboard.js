...
class Dashboard extends Component {
  ...
  render() {
    return <div>
    {
    	this.state.error ? <div className="zq-error-page"><span className="text-red">出错了~</span>{this.state.error}</div> : <div>
	    	<div className="zq-dashboard">
			    <div className="item item-type-line">
					...
					<div className="item-img">
						...
						<span className="text-red fs-20">{this.state.counts.errorCount || 0}</span>条
					</div>
				</div>
				<div className="item item-type-line">
					...
					<div className="item-img">
						...
						<span className="text-red fs-20">{this.state.counts.perfCount || 0}</span>条
					</div>
				</div>
			</div>
